...
$root.ics23 = (function () {
  ...
  ics23.ExistenceProof = (function () {
    ...
    ExistenceProof.encode = function encode(message, writer) {
      ...
      if (message.leaf != null && message.hasOwnProperty("leaf"))
        $root.ics23.LeafOp.encode(
          message.leaf,
          writer.uint32(/* id 3, wireType 2 =*/ 26).fork()
        ).ldelim();
      if (message.path != null && message.path.length)
        for (var i = 0; i < message.path.length; ++i)
          $root.ics23.InnerOp.encode(
            message.path[i],
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 4:
            ...
            message.path.push(
              $root.ics23.InnerOp.decode(reader, reader.uint32())
            );
            break;
          default:
    ...
    ExistenceProof.toObject = function toObject(message, options) {
      ...
      if (message.path && message.path.length) {
        ...
        for (var j = 0; j < message.path.length; ++j)
          object.path[j] = $root.ics23.InnerOp.toObject(
            message.path[j],
            options
          );
      }
  ...
  ics23.NonExistenceProof = (function () {
    ...
    NonExistenceProof.encode = function encode(message, writer) {
      ...
      if (message.left != null && message.hasOwnProperty("left"))
        $root.ics23.ExistenceProof.encode(
          message.left,
     ...
     * @returns {$protobuf.Writer} Writer
     */
    NonExistenceProof.encodeDelimited = function encodeDelimited(
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim();
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1:
            ...
            break;
          case 2:
            message.left = $root.ics23.ExistenceProof.decode(
              reader,
              reader.uint32()
            );
            break;
          case 3:
            message.right = $root.ics23.ExistenceProof.decode(
              reader,
              reader.uint32()
            );
            break;
      ...
      if (message.key != null && message.hasOwnProperty("key"))
        object.key =
          options.bytes === String
            ...
            : message.key;
      if (message.left != null && message.hasOwnProperty("left"))
        object.left = $root.ics23.ExistenceProof.toObject(
          message.left,
          options
        );
      if (message.right != null && message.hasOwnProperty("right"))
        object.right = $root.ics23.ExistenceProof.toObject(
          message.right,
          options
        );
      return object;
  ...
  ics23.CommitmentProof = (function () {
    ...
    Object.defineProperty(CommitmentProof.prototype, "proof", {
      get: $util.oneOfGetter(
        ($oneOfFields = ["exist", "nonexist", "batch", "compressed"])
      ),
    ...
    CommitmentProof.encode = function encode(message, writer) {
      ...
      if (message.nonexist != null && message.hasOwnProperty("nonexist"))
        $root.ics23.NonExistenceProof.encode(
          message.nonexist,
          writer.uint32(/* id 2, wireType 2 =*/ 18).fork()
        ).ldelim();
      if (message.batch != null && message.hasOwnProperty("batch"))
        $root.ics23.BatchProof.encode(
          message.batch,
          writer.uint32(/* id 3, wireType 2 =*/ 26).fork()
        ).ldelim();
      if (message.compressed != null && message.hasOwnProperty("compressed"))
        $root.ics23.CompressedBatchProof.encode(
          message.compressed,
          writer.uint32(/* id 4, wireType 2 =*/ 34).fork()
        ).ldelim();
      return writer;
     ...
     * @returns {$protobuf.Writer} Writer
     */
    CommitmentProof.encodeDelimited = function encodeDelimited(
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim();
    ...
    CommitmentProof.decode = function decode(reader, length) {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1:
            message.exist = $root.ics23.ExistenceProof.decode(
              reader,
              reader.uint32()
            );
            break;
          case 2:
            message.nonexist = $root.ics23.NonExistenceProof.decode(
              reader,
              reader.uint32()
            );
            break;
          case 3:
            message.batch = $root.ics23.BatchProof.decode(
              reader,
              reader.uint32()
            );
            break;
          case 4:
            message.compressed = $root.ics23.CompressedBatchProof.decode(
              reader,
              reader.uint32()
            );
            break;
    ...
    CommitmentProof.verify = function verify(message) {
      ...
      if (message.compressed != null && message.hasOwnProperty("compressed")) {
        ...
        properties.proof = 1;
        {
          var error = $root.ics23.CompressedBatchProof.verify(
            message.compressed
          );
    ...
    CommitmentProof.fromObject = function fromObject(object) {
      ...
      if (object.nonexist != null) {
        ...
        message.nonexist = $root.ics23.NonExistenceProof.fromObject(
          object.nonexist
        );
      }
      ...
      if (object.compressed != null) {
        ...
        message.compressed = $root.ics23.CompressedBatchProof.fromObject(
          object.compressed
        );
      }
      return message;
    ...
    CommitmentProof.toObject = function toObject(message, options) {
      ...
      var object = {};
      if (message.exist != null && message.hasOwnProperty("exist")) {
        object.exist = $root.ics23.ExistenceProof.toObject(
          message.exist,
          options
        );
      ...
      if (message.nonexist != null && message.hasOwnProperty("nonexist")) {
        object.nonexist = $root.ics23.NonExistenceProof.toObject(
          message.nonexist,
          options
        );
      ...
      if (message.compressed != null && message.hasOwnProperty("compressed")) {
        object.compressed = $root.ics23.CompressedBatchProof.toObject(
          message.compressed,
          options
        );
  ...
  ics23.LeafOp = (function () {
    ...
    LeafOp.encode = function encode(message, writer) {
      ...
      if (
        message.prehashValue != null &&
        message.hasOwnProperty("prehashValue")
      )
    ...
    LeafOp.verify = function verify(message) {
      ...
      if (message.prefix != null && message.hasOwnProperty("prefix"))
        if (
          !(
            (message.prefix && typeof message.prefix.length === "number") ||
            $util.isString(message.prefix)
          )
        )
    ...
    LeafOp.fromObject = function fromObject(object) {
      ...
      if (object.prefix != null)
        if (typeof object.prefix === "string")
          $util.base64.decode(
            object.prefix,
            (message.prefix = $util.newBuffer(
              $util.base64.length(object.prefix)
            )),
            0
          );
      ...
      if (message.hash != null && message.hasOwnProperty("hash"))
        object.hash =
          options.enums === String
            ? $root.ics23.HashOp[message.hash]
            : message.hash;
      if (message.prehashKey != null && message.hasOwnProperty("prehashKey"))
        object.prehashKey =
          options.enums === String
            ? $root.ics23.HashOp[message.prehashKey]
            : message.prehashKey;
      if (
        message.prehashValue != null &&
        message.hasOwnProperty("prehashValue")
        ...
        object.prehashValue =
          options.enums === String
            ? $root.ics23.HashOp[message.prehashValue]
            : message.prehashValue;
      if (message.length != null && message.hasOwnProperty("length"))
        object.length =
          options.enums === String
            ? $root.ics23.LengthOp[message.length]
            : message.length;
      if (message.prefix != null && message.hasOwnProperty("prefix"))
        object.prefix =
          options.bytes === String
  ...
  ics23.InnerOp = (function () {
    ...
    InnerOp.verify = function verify(message) {
      ...
      if (message.suffix != null && message.hasOwnProperty("suffix"))
        if (
          !(
            (message.suffix && typeof message.suffix.length === "number") ||
            $util.isString(message.suffix)
          )
        )
    ...
    InnerOp.fromObject = function fromObject(object) {
      ...
      if (object.suffix != null)
        if (typeof object.suffix === "string")
          $util.base64.decode(
            object.suffix,
            (message.suffix = $util.newBuffer(
              $util.base64.length(object.suffix)
            )),
            0
          );
    ...
    InnerOp.toObject = function toObject(message, options) {
      ...
      if (message.suffix != null && message.hasOwnProperty("suffix"))
        object.suffix =
          options.bytes === String
            ? $util.base64.encode(message.suffix, 0, message.suffix.length)
            : options.bytes === Array
            ? Array.prototype.slice.call(message.suffix)
            : message.suffix;
      return object;
    };
  ...
  ics23.ProofSpec = (function () {
    ...
    ProofSpec.decode = function decode(reader, length) {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1:
            message.leafSpec = $root.ics23.LeafOp.decode(
              reader,
              reader.uint32()
            );
            break;
          case 2:
            message.innerSpec = $root.ics23.InnerSpec.decode(
              reader,
              reader.uint32()
            );
            break;
    ...
    ProofSpec.toObject = function toObject(message, options) {
      ...
      if (message.leafSpec != null && message.hasOwnProperty("leafSpec"))
        object.leafSpec = $root.ics23.LeafOp.toObject(
          message.leafSpec,
          options
        );
      if (message.innerSpec != null && message.hasOwnProperty("innerSpec"))
        object.innerSpec = $root.ics23.InnerSpec.toObject(
          message.innerSpec,
          options
        );
      if (message.maxDepth != null && message.hasOwnProperty("maxDepth"))
  ...
  ics23.InnerSpec = (function () {
    ...
    InnerSpec.encode = function encode(message, writer) {
      ...
      if (
        message.minPrefixLength != null &&
        message.hasOwnProperty("minPrefixLength")
      )
        writer
          .uint32(/* id 3, wireType 0 =*/ 24)
          .int32(message.minPrefixLength);
      if (
        message.maxPrefixLength != null &&
        message.hasOwnProperty("maxPrefixLength")
      )
        writer
    ...
    InnerSpec.verify = function verify(message) {
      ...
      if (message.emptyChild != null && message.hasOwnProperty("emptyChild"))
        if (
          !(
            (message.emptyChild &&
              typeof message.emptyChild.length === "number") ||
            $util.isString(message.emptyChild)
          )
        )
    ...
    InnerSpec.fromObject = function fromObject(object) {
      ...
      if (object.emptyChild != null)
        if (typeof object.emptyChild === "string")
          $util.base64.decode(
            object.emptyChild,
            (message.emptyChild = $util.newBuffer(
              $util.base64.length(object.emptyChild)
            )),
            0
          );
        ...
        object.emptyChild =
          options.bytes === String
            ? $util.base64.encode(
                message.emptyChild,
                0,
                message.emptyChild.length
              )
            : options.bytes === Array
            ? Array.prototype.slice.call(message.emptyChild)
            : message.emptyChild;
      if (message.hash != null && message.hasOwnProperty("hash"))
        object.hash =
          options.enums === String
        ...
        switch (tag >>> 3) {
          case 1:
            ...
            message.entries.push(
              $root.ics23.BatchEntry.decode(reader, reader.uint32())
            );
            break;
          default:
            reader.skipType(tag & 7);
    ...
    BatchProof.fromObject = function fromObject(object) {
      ...
      if (object.entries) {
        ...
        for (var i = 0; i < object.entries.length; ++i) {
          ...
          message.entries[i] = $root.ics23.BatchEntry.fromObject(
            object.entries[i]
          );
        }
      }
    ...
    BatchProof.toObject = function toObject(message, options) {
      ...
      if (message.entries && message.entries.length) {
        ...
        for (var j = 0; j < message.entries.length; ++j)
          object.entries[j] = $root.ics23.BatchEntry.toObject(
            message.entries[j],
            options
          );
      }
  ...
  ics23.CompressedBatchProof = (function () {
    ...
    CompressedBatchProof.encode = function encode(message, writer) {
      ...
      if (message.entries != null && message.entries.length)
        for (var i = 0; i < message.entries.length; ++i)
          $root.ics23.CompressedBatchEntry.encode(
            message.entries[i],
            writer.uint32(/* id 1, wireType 2 =*/ 10).fork()
          ).ldelim();
     ...
     * @returns {$protobuf.Writer} Writer
     */
    CompressedBatchProof.encodeDelimited = function encodeDelimited(
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim();
        ...
        switch (tag >>> 3) {
          case 1:
            if (!(message.entries && message.entries.length))
              message.entries = [];
            message.entries.push(
              $root.ics23.CompressedBatchEntry.decode(reader, reader.uint32())
            );
            break;
          case 2:
    ...
    CompressedBatchProof.verify = function verify(message) {
      ...
      if (message.entries != null && message.hasOwnProperty("entries")) {
        if (!Array.isArray(message.entries)) return "entries: array expected";
        for (var i = 0; i < message.entries.length; ++i) {
          var error = $root.ics23.CompressedBatchEntry.verify(
            message.entries[i]
          );
          if (error) return "entries." + error;
        }
      ...
      if (
        message.lookupInners != null &&
        message.hasOwnProperty("lookupInners")
      ) {
    ...
    CompressedBatchProof.fromObject = function fromObject(object) {
      ...
      if (object.entries) {
        ...
        for (var i = 0; i < object.entries.length; ++i) {
          ...
          message.entries[i] = $root.ics23.CompressedBatchEntry.fromObject(
            object.entries[i]
          );
        }
      }
      if (object.lookupInners) {
        ...
        for (var i = 0; i < object.lookupInners.length; ++i) {
          ...
          message.lookupInners[i] = $root.ics23.InnerOp.fromObject(
            object.lookupInners[i]
          );
        }
      }
      return message;
    ...
    CompressedBatchProof.toObject = function toObject(message, options) {
      ...
      if (message.entries && message.entries.length) {
        object.entries = [];
        for (var j = 0; j < message.entries.length; ++j)
          object.entries[j] = $root.ics23.CompressedBatchEntry.toObject(
            message.entries[j],
            options
          );
      }
      if (message.lookupInners && message.lookupInners.length) {
        ...
        for (var j = 0; j < message.lookupInners.length; ++j)
          object.lookupInners[j] = $root.ics23.InnerOp.toObject(
            message.lookupInners[j],
            options
          );
      }
      return object;
  ...
  ics23.CompressedBatchEntry = (function () {
    ...
    CompressedBatchEntry.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (message.exist != null && message.hasOwnProperty("exist"))
        $root.ics23.CompressedExistenceProof.encode(
          message.exist,
          writer.uint32(/* id 1, wireType 2 =*/ 10).fork()
        ).ldelim();
      if (message.nonexist != null && message.hasOwnProperty("nonexist"))
        $root.ics23.CompressedNonExistenceProof.encode(
          message.nonexist,
          writer.uint32(/* id 2, wireType 2 =*/ 18).fork()
        ).ldelim();
      return writer;
     ...
     * @returns {$protobuf.Writer} Writer
     */
    CompressedBatchEntry.encodeDelimited = function encodeDelimited(
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim();
    ...
    CompressedBatchEntry.decode = function decode(reader, length) {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1:
            message.exist = $root.ics23.CompressedExistenceProof.decode(
              reader,
              reader.uint32()
            );
            break;
          case 2:
            message.nonexist = $root.ics23.CompressedNonExistenceProof.decode(
              reader,
              reader.uint32()
            );
            break;
    ...
    CompressedBatchEntry.verify = function verify(message) {
      ...
      if (message.exist != null && message.hasOwnProperty("exist")) {
        properties.proof = 1;
        {
          var error = $root.ics23.CompressedExistenceProof.verify(
            message.exist
          );
          if (error) return "exist." + error;
        }
      ...
      if (message.nonexist != null && message.hasOwnProperty("nonexist")) {
        ...
        properties.proof = 1;
        {
          var error = $root.ics23.CompressedNonExistenceProof.verify(
            message.nonexist
          );
          if (error) return "nonexist." + error;
        }
    ...
    CompressedBatchEntry.fromObject = function fromObject(object) {
      ...
      if (object.exist != null) {
        ...
        message.exist = $root.ics23.CompressedExistenceProof.fromObject(
          object.exist
        );
      }
      if (object.nonexist != null) {
        ...
        message.nonexist = $root.ics23.CompressedNonExistenceProof.fromObject(
          object.nonexist
        );
      }
      return message;
    ...
    CompressedBatchEntry.toObject = function toObject(message, options) {
      ...
      var object = {};
      if (message.exist != null && message.hasOwnProperty("exist")) {
        object.exist = $root.ics23.CompressedExistenceProof.toObject(
          message.exist,
          options
        );
        if (options.oneofs) object.proof = "exist";
      ...
      if (message.nonexist != null && message.hasOwnProperty("nonexist")) {
        object.nonexist = $root.ics23.CompressedNonExistenceProof.toObject(
          message.nonexist,
          options
        );
        if (options.oneofs) object.proof = "nonexist";
  ...
  ics23.CompressedExistenceProof = (function () {
     ...
     * @returns {$protobuf.Writer} Writer
     */
    CompressedExistenceProof.encodeDelimited = function encodeDelimited(
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim();
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    CompressedExistenceProof.decodeDelimited = function decodeDelimited(
      reader
    ) {
      if (!(reader instanceof $Reader)) reader = new $Reader(reader);
      return this.decode(reader, reader.uint32());
  ...
  ics23.CompressedNonExistenceProof = (function () {
     ...
     * @returns {$protobuf.Writer} Writer
     */
    CompressedNonExistenceProof.encodeDelimited = function encodeDelimited(
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim();
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1:
            ...
            break;
          case 2:
            message.left = $root.ics23.CompressedExistenceProof.decode(
              reader,
              reader.uint32()
            );
            break;
          case 3:
            message.right = $root.ics23.CompressedExistenceProof.decode(
              reader,
              reader.uint32()
            );
            break;
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    CompressedNonExistenceProof.decodeDelimited = function decodeDelimited(
      reader
    ) {
      if (!(reader instanceof $Reader)) reader = new $Reader(reader);
      return this.decode(reader, reader.uint32());
    ...
    CompressedNonExistenceProof.fromObject = function fromObject(object) {
      ...
      if (object.left != null) {
        ...
        message.left = $root.ics23.CompressedExistenceProof.fromObject(
          object.left
        );
      }
      if (object.right != null) {
        ...
        message.right = $root.ics23.CompressedExistenceProof.fromObject(
          object.right
        );
      }
      return message;
      ...
      if (message.key != null && message.hasOwnProperty("key"))
        object.key =
          options.bytes === String
            ...
            : message.key;
      if (message.left != null && message.hasOwnProperty("left"))
        object.left = $root.ics23.CompressedExistenceProof.toObject(
          message.left,
          options
        );
      if (message.right != null && message.hasOwnProperty("right"))
        object.right = $root.ics23.CompressedExistenceProof.toObject(
          message.right,
          options
        );
      return object;
