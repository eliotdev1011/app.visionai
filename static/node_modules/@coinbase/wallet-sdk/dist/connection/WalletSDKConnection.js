...
class WalletSDKConnection {
  ...
  constructor(
    ...
    const ws = new RxWebSocket_1.RxWebSocket(
      linkAPIUrl + "/rpc",
      WebSocketClass
    );
    this.ws = ws;
      ...
      ws.connectionState$
        .pipe(
          (0, operators_1.tap)((state) => {
            var _a;
            return (_a = this.diagnostic) === null || _a === void 0
              ? void 0
          ...
          (0, operators_1.filter)(
            (cs) =>
              cs === RxWebSocket_1.ConnectionState.DISCONNECTED &&
              !this.destroyed
          ),
          // wait 5 seconds
    ...
    this.subscriptions.add(
      ws.incomingJSONData$
        .pipe(
          (0, operators_1.filter)((m) =>
            ["IsLinkedOK", "Linked"].includes(m.type)
          )
        )
        .subscribe((m) => {
          var _a;
    ...
    this.subscriptions.add(
      ws.incomingJSONData$
        ...
        .subscribe((m) => {
          ...
          (_a = this.diagnostic) === null || _a === void 0
            ? void 0
            : _a.log(DiagnosticLogger_1.EVENTS.SESSION_CONFIG_RECEIVED, {
                sessionIdHash: Session_1.Session.hash(sessionId),
                metadata_keys:
  ...
  setSessionMetadata(key, value) {
    ...
    return this.onceConnected$.pipe(
      (0, operators_1.flatMap)((_) => this.makeRequest(message)),
  ...
  makeRequest(message, timeout = REQUEST_TIMEOUT) {
    ...
    return this.ws.incomingJSONData$.pipe(
      (0, operators_1.timeoutWith)(
        timeout,
        (0, rxjs_1.throwError)(new Error(`request ${reqId} timed out`))
      ),
      (0, operators_1.filter)((m) => m.id === reqId),
      (0, operators_1.take)(1)
    );
  }
  authenticate() {
    ...
    return this.makeRequest(msg).pipe(
      (0, operators_1.map)((res) => {
        if ((0, ServerMessage_1.isServerMessageFail)(res)) {
