...
class WalletSDKRelay extends WalletSDKRelayAbstract_1.WalletSDKRelayAbstract {
  ...
  subscribe() {
    ...
    const connection = new WalletSDKConnection_1.WalletSDKConnection(
      session.id,
      session.key,
      this.linkAPIUrl,
      this.diagnostic
      ...
      connection.sessionConfig$.subscribe({
        ...
        error: () => {
          ...
          (_a = this.diagnostic) === null || _a === void 0
            ? void 0
            : _a.log(DiagnosticLogger_1.EVENTS.GENERAL_ERROR, {
    ...
    this.subscriptions.add(
      connection.linked$
        .pipe(
          ...
          (0, operators_1.tap)((linked) => {
            var _a;
            this.isLinked = linked;
            const cachedAddresses = this.storage.getItem(
              WalletSDKRelayAbstract_1.LOCAL_STORAGE_ADDRESSES_KEY
            );
            if (linked) {
      ...
      connection.sessionConfig$
        .pipe(
          (0, operators_1.filter)(
            (c) => !!c.metadata && c.metadata.__destroyed === "1"
          )
        )
        .subscribe(() => {
          var _a;
          ...
          (_a = this.diagnostic) === null || _a === void 0
            ? void 0
            : _a.log(DiagnosticLogger_1.EVENTS.METADATA_DESTROYED, {
                alreadyDestroyed,
    ...
    this.subscriptions.add(
      connection.sessionConfig$
        .pipe(
          (0, operators_1.filter)(
            (c) => c.metadata && c.metadata.WalletUsername !== undefined
          )
        )
        .pipe(
          (0, operators_1.mergeMap)((c) =>
        ...
        .subscribe({
          next: (walletUsername) => {
            this.storage.setItem(
              WalletSDKRelayAbstract_1.WALLET_USER_NAME_KEY,
              walletUsername
            );
          },
          error: () => {
    ...
    this.subscriptions.add(
      connection.sessionConfig$
        .pipe(
          (0, operators_1.filter)(
            (c) => c.metadata && c.metadata.AppVersion !== undefined
          )
        )
        .pipe(
          (0, operators_1.mergeMap)((c) =>
        ...
        .subscribe({
          next: (appVersion) => {
            this.storage.setItem(
              WalletSDKRelayAbstract_1.APP_VERSION_KEY,
              appVersion
            );
          },
          error: () => {
    ...
    this.subscriptions.add(
      connection.sessionConfig$
        .pipe(
          (0, operators_1.filter)(
            (c) => c.metadata && c.metadata.EthereumAddress !== undefined
          )
        )
        .pipe(
          (0, operators_1.mergeMap)((c) =>
    ...
    this.subscriptions.add(
      connection.sessionConfig$
        .pipe(
          (0, operators_1.filter)(
            (c) => c.metadata && c.metadata.AppSrc !== undefined
          )
        )
        .pipe(
          (0, operators_1.mergeMap)((c) =>
            aes256gcm.decrypt(c.metadata.AppSrc, session.secret)
          )
        )
        .subscribe({
          next: (appSrc) => {
  ...
  resetAndReload() {
    this.connection
      ...
      .pipe(
        (0, operators_1.timeout)(1000),
        (0, operators_1.catchError)((_) => (0, rxjs_1.of)(null))
      )
      .subscribe(
        (_) => {
          var _a, _b, _c;
          ...
          (_b = this.diagnostic) === null || _b === void 0
            ? void 0
            : _b.log(DiagnosticLogger_1.EVENTS.SESSION_STATE_CHANGE, {
          ...
          if (
            ...
            (_c = this.diagnostic) === null || _c === void 0
              ? void 0
              : _c.log(DiagnosticLogger_1.EVENTS.SKIPPED_CLEARING_SESSION, {
                  sessionIdHash: this.getSessionIdHash(),
      ...
      this.publishEvent("Web3Request", message, true).subscribe({
        ...
        error: (err) => {
          this.handleWeb3ResponseMessage(
            (0, Web3ResponseMessage_1.Web3ResponseMessage)({
              id: message.id,
              response: {
  ...
  publishWeb3RequestCanceledEvent(id) {
    const message = (0,
    Web3RequestCanceledMessage_1.Web3RequestCanceledMessage)(id);
    this.subscriptions.add(
  ...
  publishEvent(event, message, callWebhook) {
    ...
    return new rxjs_1.Observable((subscriber) => {
      ...
      (0, operators_1.mergeMap)((encrypted) => {
  ...
  handleIncomingEvent(event) {
    try {
      this.subscriptions.add(
        (0, rxjs_1.from)(aes256gcm.decrypt(event.data, this.session.secret))
          .pipe((0, operators_1.map)((c) => JSON.parse(c)))
          .subscribe({
            next: (json) => {
              const message = (0, Web3ResponseMessage_1.isWeb3ResponseMessage)(
                json
              )
                ? json
                : null;
  ...
  handleErrorResponse(id, method, error, errorCode) {
    ...
    const errorMessage =
      (_a = error === null || error === void 0 ? void 0 : error.message) !==
        null && _a !== void 0
        ? _a
        : (0, errors_1.standardErrorMessage)(errorCode);
    this.handleWeb3ResponseMessage(
      (0, Web3ResponseMessage_1.Web3ResponseMessage)({
        id,
        response: {
  ...
  requestEthereumAccounts() {
    ...
    const promise = new Promise((resolve, reject) => {
      ...
      if (this.ui.inlineAccountsResponse()) {
        ...
        const err = errors_1.standardErrors.provider.userRejectedRequest(
    ...
    const promise = new Promise((resolve, reject) => {
      ...
      const _cancel = (_error) => {
        this.handleWeb3ResponseMessage(
          (0, Web3ResponseMessage_1.Web3ResponseMessage)({
            id,
            response: (0, Web3Response_1.SelectProviderResponse)(
              types_1.ProviderType.Unselected
            ),
          })
        );
      };
    ...
    const promise = new Promise((resolve, reject) => {
      this.relayEventManager.callbacks.set(id, (response) => {
        if (
          ...
          return reject(
            errors_1.standardErrors.provider.custom({
      ...
      const _cancel = (error) => {
        ...
        if (error) {
          ...
          const errorCode =
            (_a = (0, errors_1.getErrorCode)(error)) !== null && _a !== void 0
              ? _a
              : errors_1.standardErrorCodes.provider.unsupportedChain;
          this.handleErrorResponse(
            id,
            Web3Method_1.Web3Method.switchEthereumChain,
            error instanceof Error
              ? error
              : errors_1.standardErrors.provider.unsupportedChain(chainId),
            errorCode
          );
        } else {
          this.handleWeb3ResponseMessage(
