...
class CoinbaseWalletProvider extends safe_event_emitter_1.default {
  ...
  async switchEthereumChain(chainId) {
    ...
    if ((0, Web3Response_1.isErrorResponse)(res) && res.errorCode) {
      if (
        res.errorCode === errors_1.standardErrorCodes.provider.unsupportedChain
      ) {
  ...
  async scanQRCode(match) {
    ...
    if (typeof res.result !== "string") {
      throw (0, errors_1.serializeError)(
        (_a = res.errorMessage) !== null && _a !== void 0
          ? _a
          : "result was not a string",
        Web3Method_1.Web3Method.scanQRCode
      );
    }
    return res.result;
  }
    ...
    if (typeof res.result !== "string") {
      throw (0, errors_1.serializeError)(
        (_a = res.errorMessage) !== null && _a !== void 0
          ? _a
          : "result was not a string",
        Web3Method_1.Web3Method.generic
      );
    }
    return res.result;
  }
    ...
    if (typeof res.result !== "string") {
      throw (0, errors_1.serializeError)(
        (_a = res.errorMessage) !== null && _a !== void 0
          ? _a
          : "result was not a string",
        Web3Method_1.Web3Method.selectProvider
      );
    }
    return res.result;
  }
  ...
  async _signEthereumMessage(message, address, addPrefix, typedDataJson) {
    ...
    try {
      ...
      if (
        ...
        throw errors_1.standardErrors.provider.userRejectedRequest(
  ...
  async _wallet_addEthereumChain(params) {
    ...
    if (!request.chainName || request.chainName.trim() === "") {
      throw errors_1.standardErrors.rpc.invalidParams(
