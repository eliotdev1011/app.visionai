...
exports.standardErrorCodes = Object.freeze(
  Object.assign(Object.assign({}, eth_rpc_errors_1.errorCodes), {
    provider: Object.freeze(
      Object.assign(Object.assign({}, eth_rpc_errors_1.errorCodes.provider), {
...
function standardErrorMessage(code) {
  return code !== undefined
    ? (0, eth_rpc_errors_1.getMessageFromCode)(code)
    : "Unknown error";
}
exports.standardErrorMessage = standardErrorMessage;
exports.standardErrors = Object.freeze(
  Object.assign(Object.assign({}, eth_rpc_errors_1.ethErrors), {
    provider: Object.freeze(
      Object.assign(Object.assign({}, eth_rpc_errors_1.ethErrors.provider), {
        unsupportedChain: (chainId = "") =>
          eth_rpc_errors_1.ethErrors.provider.custom({
...
function serializeError(error, requestOrMethod) {
  const serialized = (0, eth_rpc_errors_1.serializeError)(
...
function getMethod(serializedData, request) {
  var _a;
  const methodInData =
    (_a = serializedData) === null || _a === void 0 ? void 0 : _a.method;
  if (methodInData) {
    return methodInData;
  }
