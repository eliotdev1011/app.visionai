...
exports.CoinbaseAppSteps =
  exports.CoinbaseWalletSteps =
  exports.ConnectItem =
  exports.ConnectContent =
    void 0;
...
const coinbase_round_svg_1 = __importDefault(
  require("../icons/coinbase-round-svg")
);
const coinbase_wallet_round_svg_1 = __importDefault(
  require("../icons/coinbase-wallet-round-svg")
);
...
function ConnectItem({ title, description, icon, selected, theme, onClick }) {
  return (0, preact_1.h)(
    ...
    {
      onClick: onClick,
      class: (0, clsx_1.default)("-cbwsdk-connect-item", theme, { selected }),
    },
    (0, preact_1.h)(
      "div",
      null,
