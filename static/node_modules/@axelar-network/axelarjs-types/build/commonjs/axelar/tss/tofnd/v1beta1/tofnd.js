...
exports.SignInit =
  ...
  exports.messageOut_CriminalList_Criminal_CrimeTypeToJSON =
  exports.messageOut_CriminalList_Criminal_CrimeTypeFromJSON =
  exports.MessageOut_CriminalList_Criminal_CrimeType =
  exports.recoverResponse_ResponseToJSON =
  exports.recoverResponse_ResponseFromJSON =
  exports.RecoverResponse_Response =
...
(function (RecoverResponse_Response) {
  RecoverResponse_Response[
    (RecoverResponse_Response["RESPONSE_UNSPECIFIED"] = 0)
  ] = "RESPONSE_UNSPECIFIED";
  RecoverResponse_Response[(RecoverResponse_Response["RESPONSE_SUCCESS"] = 1)] =
    "RESPONSE_SUCCESS";
  RecoverResponse_Response[(RecoverResponse_Response["RESPONSE_FAIL"] = 2)] =
    "RESPONSE_FAIL";
  RecoverResponse_Response[(RecoverResponse_Response["UNRECOGNIZED"] = -1)] =
    "UNRECOGNIZED";
})(
  (RecoverResponse_Response =
    exports.RecoverResponse_Response || (exports.RecoverResponse_Response = {}))
);
...
(function (MessageOut_CriminalList_Criminal_CrimeType) {
  MessageOut_CriminalList_Criminal_CrimeType[
    (MessageOut_CriminalList_Criminal_CrimeType["CRIME_TYPE_UNSPECIFIED"] = 0)
  ] = "CRIME_TYPE_UNSPECIFIED";
  MessageOut_CriminalList_Criminal_CrimeType[
    (MessageOut_CriminalList_Criminal_CrimeType["CRIME_TYPE_NON_MALICIOUS"] = 1)
  ] = "CRIME_TYPE_NON_MALICIOUS";
  MessageOut_CriminalList_Criminal_CrimeType[
    (MessageOut_CriminalList_Criminal_CrimeType["CRIME_TYPE_MALICIOUS"] = 2)
  ] = "CRIME_TYPE_MALICIOUS";
  MessageOut_CriminalList_Criminal_CrimeType[
    (MessageOut_CriminalList_Criminal_CrimeType["UNRECOGNIZED"] = -1)
  ] = "UNRECOGNIZED";
})(
  (MessageOut_CriminalList_Criminal_CrimeType =
    exports.MessageOut_CriminalList_Criminal_CrimeType ||
...
exports.messageOut_CriminalList_Criminal_CrimeTypeFromJSON =
  messageOut_CriminalList_Criminal_CrimeTypeFromJSON;
...
exports.messageOut_CriminalList_Criminal_CrimeTypeToJSON =
  messageOut_CriminalList_Criminal_CrimeTypeToJSON;
...
exports.RecoverRequest = {
  encode(message, writer = minimal_1.default.Writer.create()) {
    if (message.keygenInit !== undefined) {
      exports.KeygenInit.encode(
        message.keygenInit,
        writer.uint32(10).fork()
      ).ldelim();
    }
    if (message.keygenOutput !== undefined) {
      exports.KeygenOutput.encode(
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.keygenInit = exports.KeygenInit.decode(
            reader,
            reader.uint32()
          );
          break;
        case 2:
          message.keygenOutput = exports.KeygenOutput.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object) {
    return {
      keygenInit: isSet(object.keygenInit)
        ? exports.KeygenInit.fromJSON(object.keygenInit)
        : undefined,
      keygenOutput: isSet(object.keygenOutput)
        ? exports.KeygenOutput.fromJSON(object.keygenOutput)
        : undefined,
    };
  },
  toJSON(message) {
    ...
    message.keygenInit !== undefined &&
      (obj.keygenInit = message.keygenInit
        ? exports.KeygenInit.toJSON(message.keygenInit)
        : undefined);
    message.keygenOutput !== undefined &&
      (obj.keygenOutput = message.keygenOutput
        ? exports.KeygenOutput.toJSON(message.keygenOutput)
        : undefined);
    return obj;
  },
  create(base) {
...
exports.MessageIn = {
  encode(message, writer = minimal_1.default.Writer.create()) {
    ...
    if (message.signInit !== undefined) {
      exports.SignInit.encode(
        message.signInit,
        writer.uint32(18).fork()
      ).ldelim();
    }
    if (message.traffic !== undefined) {
      exports.TrafficIn.encode(
        message.traffic,
  ...
  fromJSON(object) {
    return {
      ...
      signInit: isSet(object.signInit)
        ? exports.SignInit.fromJSON(object.signInit)
        : undefined,
      traffic: isSet(object.traffic)
        ? exports.TrafficIn.fromJSON(object.traffic)
        : undefined,
  ...
  toJSON(message) {
    ...
    message.signInit !== undefined &&
      (obj.signInit = message.signInit
        ? exports.SignInit.toJSON(message.signInit)
        : undefined);
    message.traffic !== undefined &&
      (obj.traffic = message.traffic
        ? exports.TrafficIn.toJSON(message.traffic)
        : undefined);
...
exports.MessageOut = {
  encode(message, writer = minimal_1.default.Writer.create()) {
    if (message.traffic !== undefined) {
      exports.TrafficOut.encode(
        message.traffic,
        writer.uint32(10).fork()
      ).ldelim();
    }
    if (message.keygenResult !== undefined) {
      exports.MessageOut_KeygenResult.encode(
        message.keygenResult,
        writer.uint32(18).fork()
      ).ldelim();
    }
    if (message.signResult !== undefined) {
      exports.MessageOut_SignResult.encode(
        message.signResult,
        writer.uint32(26).fork()
      ).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.keygenResult = exports.MessageOut_KeygenResult.decode(
            reader,
            reader.uint32()
          );
          break;
        case 3:
          message.signResult = exports.MessageOut_SignResult.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object) {
    return {
      traffic: isSet(object.traffic)
        ? exports.TrafficOut.fromJSON(object.traffic)
        : undefined,
      ...
      signResult: isSet(object.signResult)
        ? exports.MessageOut_SignResult.fromJSON(object.signResult)
        : undefined,
  ...
  toJSON(message) {
    ...
    message.traffic !== undefined &&
      (obj.traffic = message.traffic
        ? exports.TrafficOut.toJSON(message.traffic)
        : undefined);
    ...
    message.signResult !== undefined &&
      (obj.signResult = message.signResult
        ? exports.MessageOut_SignResult.toJSON(message.signResult)
        : undefined);
...
exports.MessageOut_KeygenResult = {
  encode(message, writer = minimal_1.default.Writer.create()) {
    ...
    if (message.criminals !== undefined) {
      exports.MessageOut_CriminalList.encode(
        message.criminals,
        writer.uint32(18).fork()
      ).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.criminals = exports.MessageOut_CriminalList.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object) {
    return {
      data: isSet(object.data)
        ? exports.KeygenOutput.fromJSON(object.data)
        : undefined,
      criminals: isSet(object.criminals)
        ? exports.MessageOut_CriminalList.fromJSON(object.criminals)
        : undefined,
    };
  },
  toJSON(message) {
    ...
    message.data !== undefined &&
      (obj.data = message.data
        ? exports.KeygenOutput.toJSON(message.data)
        : undefined);
    message.criminals !== undefined &&
      (obj.criminals = message.criminals
        ? exports.MessageOut_CriminalList.toJSON(message.criminals)
        : undefined);
    return obj;
  },
  create(base) {
...
exports.MessageOut_CriminalList = {
  encode(message, writer = minimal_1.default.Writer.create()) {
    for (const v of message.criminals) {
      exports.MessageOut_CriminalList_Criminal.encode(
        v,
        writer.uint32(10).fork()
      ).ldelim();
    }
      ...
      switch (tag >>> 3) {
        case 1:
          message.criminals.push(
            exports.MessageOut_CriminalList_Criminal.decode(
              reader,
              reader.uint32()
            )
          );
    ...
    return {
      criminals: Array.isArray(object?.criminals)
        ? object.criminals.map((e) =>
            exports.MessageOut_CriminalList_Criminal.fromJSON(e)
          )
        : [],
    };
  },
  toJSON(message) {
    ...
    if (message.criminals) {
      obj.criminals = message.criminals.map((e) =>
        e ? exports.MessageOut_CriminalList_Criminal.toJSON(e) : undefined
      );
    } else {
      obj.criminals = [];
    }
  ...
  fromPartial(object) {
    ...
    message.criminals =
      object.criminals?.map((e) =>
        exports.MessageOut_CriminalList_Criminal.fromPartial(e)
      ) || [];
    return message;
  },
};
  ...
  fromJSON(object) {
    return {
      ...
      partyUids: Array.isArray(object?.partyUids)
        ? object.partyUids.map((e) => String(e))
        : [],
