  ...
  fromJSON(object) {
    return {
      ...
      keyRole: isSet(object.keyRole)
        ? (0, types_1.keyRoleFromJSON)(object.keyRole)
        : 0,
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          message.infos.push(
            exports.MultisigInfo_Info.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  toJSON(message) {
    ...
    if (message.infos) {
      obj.infos = message.infos.map((e) =>
        e ? exports.MultisigInfo_Info.toJSON(e) : undefined
      );
    } else {
      obj.infos = [];
    }
  ...
  fromPartial(object) {
    ...
    message.targetNum =
      object.targetNum !== undefined && object.targetNum !== null
        ...
        : long_1.default.ZERO;
    message.infos =
      object.infos?.map((e) => exports.MultisigInfo_Info.fromPartial(e)) || [];
    return message;
  },
};
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          const entry3 = exports.KeyRecoveryInfo_PrivateEntry.decode(
            reader,
            reader.uint32()
          );
...
exports.ValidatorStatus = {
  ...
  toJSON(message) {
    ...
    message.suspendedUntil !== undefined &&
      (obj.suspendedUntil = (
        message.suspendedUntil || long_1.default.UZERO
      ).toString());
    return obj;
  },
  create(base) {
