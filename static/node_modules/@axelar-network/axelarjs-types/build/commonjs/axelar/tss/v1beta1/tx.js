  ...
  fromJSON(object) {
    return {
      ...
      keyInfo: isSet(object.keyInfo)
        ? types_3.KeyInfo.fromJSON(object.keyInfo)
        : undefined,
    };
  },
  toJSON(message) {
    ...
    message.keyInfo !== undefined &&
      (obj.keyInfo = message.keyInfo
        ? types_3.KeyInfo.toJSON(message.keyInfo)
        : undefined);
    return obj;
  },
  create(base) {
...
exports.RotateKeyRequest = {
  ...
  fromJSON(object) {
    return {
      ...
      keyRole: isSet(object.keyRole)
        ? (0, types_2.keyRoleFromJSON)(object.keyRole)
        : 0,
  ...
  fromJSON(object) {
    return {
      ...
      payload: isSet(object.payload)
        ? tofnd_1.TrafficOut.fromJSON(object.payload)
        : undefined,
    };
  },
  toJSON(message) {
    ...
    message.payload !== undefined &&
      (obj.payload = message.payload
        ? tofnd_1.TrafficOut.toJSON(message.payload)
        : undefined);
    return obj;
  },
  create(base) {
...
exports.VotePubKeyRequest = {
  encode(message, writer = minimal_1.default.Writer.create()) {
    ...
    if (message.pollKey !== undefined) {
      types_1.PollKey.encode(
        message.pollKey,
        writer.uint32(18).fork()
      ).ldelim();
    }
    if (message.result !== undefined) {
      tofnd_1.MessageOut_KeygenResult.encode(
        message.result,
        writer.uint32(26).fork()
      ).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.result = tofnd_1.MessageOut_KeygenResult.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object) {
    return {
      ...
      pollKey: isSet(object.pollKey)
        ? types_1.PollKey.fromJSON(object.pollKey)
        : undefined,
      result: isSet(object.result)
        ? tofnd_1.MessageOut_KeygenResult.fromJSON(object.result)
        : undefined,
    };
  },
  toJSON(message) {
    ...
    message.pollKey !== undefined &&
      (obj.pollKey = message.pollKey
        ? types_1.PollKey.toJSON(message.pollKey)
        : undefined);
    message.result !== undefined &&
      (obj.result = message.result
        ? tofnd_1.MessageOut_KeygenResult.toJSON(message.result)
        : undefined);
    return obj;
  },
  create(base) {
...
exports.VoteSigRequest = {
  encode(message, writer = minimal_1.default.Writer.create()) {
    ...
    if (message.result !== undefined) {
      tofnd_1.MessageOut_SignResult.encode(
        message.result,
        writer.uint32(26).fork()
      ).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.result = tofnd_1.MessageOut_SignResult.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object) {
    return {
      ...
      pollKey: isSet(object.pollKey)
        ...
        : undefined,
      result: isSet(object.result)
        ? tofnd_1.MessageOut_SignResult.fromJSON(object.result)
        : undefined,
    };
  },
  toJSON(message) {
    ...
    message.result !== undefined &&
      (obj.result = message.result
        ? tofnd_1.MessageOut_SignResult.toJSON(message.result)
        : undefined);
    return obj;
  },
  create(base) {
...
exports.RegisterExternalKeysRequest = {
  encode(message, writer = minimal_1.default.Writer.create()) {
    ...
    for (const v of message.externalKeys) {
      exports.RegisterExternalKeysRequest_ExternalKey.encode(
        v,
        writer.uint32(26).fork()
      ).ldelim();
    }
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          message.externalKeys.push(
            exports.RegisterExternalKeysRequest_ExternalKey.decode(
              reader,
              reader.uint32()
            )
          );
    ...
    return {
      ...
      externalKeys: Array.isArray(object?.externalKeys)
        ? object.externalKeys.map((e) =>
            exports.RegisterExternalKeysRequest_ExternalKey.fromJSON(e)
          )
        : [],
    };
  },
  toJSON(message) {
    ...
    if (message.externalKeys) {
      obj.externalKeys = message.externalKeys.map((e) =>
        e
          ? exports.RegisterExternalKeysRequest_ExternalKey.toJSON(e)
          : undefined
      );
    } else {
      obj.externalKeys = [];
  ...
  fromPartial(object) {
    ...
    message.externalKeys =
      object.externalKeys?.map((e) =>
        exports.RegisterExternalKeysRequest_ExternalKey.fromPartial(e)
      ) || [];
    return message;
  },
};
...
exports.RegisterExternalKeysRequest_ExternalKey = {
  ...
  create(base) {
    return exports.RegisterExternalKeysRequest_ExternalKey.fromPartial(
      base ?? {}
    );
  },
  fromPartial(object) {
...
exports.SubmitMultisigPubKeysRequest = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.sigKeyPairs.push(
            types_2.SigKeyPair.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  toJSON(message) {
    ...
    if (message.sigKeyPairs) {
      obj.sigKeyPairs = message.sigKeyPairs.map((e) =>
        e ? types_2.SigKeyPair.toJSON(e) : undefined
      );
    } else {
      obj.sigKeyPairs = [];
    }
  ...
  fromPartial(object) {
    ...
    message.keyId = object.keyId ?? "";
    message.sigKeyPairs =
      object.sigKeyPairs?.map((e) => types_2.SigKeyPair.fromPartial(e)) || [];
    return message;
  },
};
