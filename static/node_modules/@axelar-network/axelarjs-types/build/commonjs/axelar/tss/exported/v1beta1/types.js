...
exports.SigKeyPair =
  ...
  exports.keyShareDistributionPolicyToJSON =
  exports.keyShareDistributionPolicyFromJSON =
  exports.KeyShareDistributionPolicy =
  exports.keyTypeToJSON =
  exports.keyTypeFromJSON =
  exports.KeyType =
  exports.keyRoleToJSON =
  exports.keyRoleFromJSON =
  exports.KeyRole =
...
(function (KeyShareDistributionPolicy) {
  ...
  KeyShareDistributionPolicy[
    (KeyShareDistributionPolicy["UNRECOGNIZED"] = -1)
  ] = "UNRECOGNIZED";
})(
  (KeyShareDistributionPolicy =
    exports.KeyShareDistributionPolicy ||
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.minKeygenThreshold = threshold_1.Threshold.decode(
            reader,
            reader.uint32()
          );
          break;
        case 4:
          message.safetyThreshold = threshold_1.Threshold.decode(
            reader,
            reader.uint32()
          );
          break;
        ...
        case 7:
          ...
          break;
        case 8:
          message.keygenVotingThreshold = threshold_1.Threshold.decode(
            reader,
            reader.uint32()
          );
          break;
        case 9:
          message.signVotingThreshold = threshold_1.Threshold.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object) {
    return {
      ...
      safetyThreshold: isSet(object.safetyThreshold)
        ? threshold_1.Threshold.fromJSON(object.safetyThreshold)
        : undefined,
  ...
  toJSON(message) {
    ...
    message.safetyThreshold !== undefined &&
      (obj.safetyThreshold = message.safetyThreshold
        ? threshold_1.Threshold.toJSON(message.safetyThreshold)
        : undefined);
    ...
    message.maxTotalShareCount !== undefined &&
      (obj.maxTotalShareCount = (
        message.maxTotalShareCount || long_1.default.ZERO
      ).toString());
    message.minTotalShareCount !== undefined &&
      (obj.minTotalShareCount = (
        message.minTotalShareCount || long_1.default.ZERO
      ).toString());
    ...
    message.keygenTimeout !== undefined &&
      (obj.keygenTimeout = (
        message.keygenTimeout || long_1.default.ZERO
      ).toString());
    message.signTimeout !== undefined &&
      (obj.signTimeout = (
        message.signTimeout || long_1.default.ZERO
      ).toString());
    return obj;
  },
  create(base) {
