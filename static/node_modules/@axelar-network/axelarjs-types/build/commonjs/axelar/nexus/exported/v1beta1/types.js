...
exports.GeneralMessage =
  ...
  exports.Chain =
  exports.generalMessage_StatusToJSON =
  exports.generalMessage_StatusFromJSON =
  exports.GeneralMessage_Status =
  exports.transferDirectionToJSON =
  exports.transferDirectionFromJSON =
  exports.TransferDirection =
  exports.transferStateToJSON =
  exports.transferStateFromJSON =
...
(function (TransferState) {
  TransferState[(TransferState["TRANSFER_STATE_UNSPECIFIED"] = 0)] =
    "TRANSFER_STATE_UNSPECIFIED";
  TransferState[(TransferState["TRANSFER_STATE_PENDING"] = 1)] =
    "TRANSFER_STATE_PENDING";
  TransferState[(TransferState["TRANSFER_STATE_ARCHIVED"] = 2)] =
    "TRANSFER_STATE_ARCHIVED";
  TransferState[(TransferState["TRANSFER_STATE_INSUFFICIENT_AMOUNT"] = 3)] =
...
(function (TransferDirection) {
  TransferDirection[(TransferDirection["TRANSFER_DIRECTION_UNSPECIFIED"] = 0)] =
    "TRANSFER_DIRECTION_UNSPECIFIED";
  TransferDirection[(TransferDirection["TRANSFER_DIRECTION_INCOMING"] = 1)] =
    "TRANSFER_DIRECTION_INCOMING";
  TransferDirection[(TransferDirection["TRANSFER_DIRECTION_OUTGOING"] = 2)] =
...
(function (GeneralMessage_Status) {
  GeneralMessage_Status[(GeneralMessage_Status["STATUS_UNSPECIFIED"] = 0)] =
    "STATUS_UNSPECIFIED";
  GeneralMessage_Status[(GeneralMessage_Status["STATUS_APPROVED"] = 1)] =
    "STATUS_APPROVED";
  GeneralMessage_Status[(GeneralMessage_Status["STATUS_PROCESSING"] = 2)] =
    "STATUS_PROCESSING";
  GeneralMessage_Status[(GeneralMessage_Status["STATUS_EXECUTED"] = 3)] =
    "STATUS_EXECUTED";
  GeneralMessage_Status[(GeneralMessage_Status["STATUS_FAILED"] = 4)] =
    "STATUS_FAILED";
  GeneralMessage_Status[(GeneralMessage_Status["UNRECOGNIZED"] = -1)] =
    "UNRECOGNIZED";
})(
  (GeneralMessage_Status =
    exports.GeneralMessage_Status || (exports.GeneralMessage_Status = {}))
);
  ...
  fromJSON(object) {
    return {
      ...
      keyType: isSet(object.keyType)
        ? (0, types_1.keyTypeFromJSON)(object.keyType)
        : 0,
  ...
  fromJSON(object) {
    return {
      chain: isSet(object.chain)
        ? exports.Chain.fromJSON(object.chain)
        : undefined,
  ...
  toJSON(message) {
    ...
    message.chain !== undefined &&
      (obj.chain = message.chain
        ? exports.Chain.toJSON(message.chain)
        : undefined);
  ...
  fromPartial(object) {
    ...
    message.chain =
      object.chain !== undefined && object.chain !== null
        ? exports.Chain.fromPartial(object.chain)
        : undefined;
...
exports.CrossChainTransfer = {
  encode(message, writer = minimal_1.default.Writer.create()) {
    if (message.recipient !== undefined) {
      exports.CrossChainAddress.encode(
        message.recipient,
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.recipient = exports.CrossChainAddress.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object) {
    return {
      recipient: isSet(object.recipient)
        ? exports.CrossChainAddress.fromJSON(object.recipient)
        : undefined,
      asset: isSet(object.asset)
        ? coin_1.Coin.fromJSON(object.asset)
        : undefined,
      id: isSet(object.id)
  ...
  toJSON(message) {
    ...
    message.recipient !== undefined &&
      (obj.recipient = message.recipient
        ? exports.CrossChainAddress.toJSON(message.recipient)
        : undefined);
    message.asset !== undefined &&
      (obj.asset = message.asset
        ? coin_1.Coin.toJSON(message.asset)
        : undefined);
  ...
  fromPartial(object) {
    ...
    message.asset =
      object.asset !== undefined && object.asset !== null
        ? coin_1.Coin.fromPartial(object.asset)
        : undefined;
    message.id =
  ...
  toJSON(message) {
    ...
    if (message.coins) {
      obj.coins = message.coins.map((e) =>
        e ? coin_1.Coin.toJSON(e) : undefined
      );
    } else {
      obj.coins = [];
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.sender = exports.CrossChainAddress.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object) {
    return {
      ...
      sender: isSet(object.sender)
        ? exports.CrossChainAddress.fromJSON(object.sender)
        : undefined,
      recipient: isSet(object.recipient)
        ? exports.CrossChainAddress.fromJSON(object.recipient)
        : undefined,
  ...
  toJSON(message) {
    ...
    message.sender !== undefined &&
      (obj.sender = message.sender
        ? exports.CrossChainAddress.toJSON(message.sender)
        : undefined);
    message.recipient !== undefined &&
      (obj.recipient = message.recipient
        ? exports.CrossChainAddress.toJSON(message.recipient)
    ...
    message.sourceTxIndex !== undefined &&
      (obj.sourceTxIndex = (
        message.sourceTxIndex || long_1.default.UZERO
      ).toString());
    return obj;
  },
  create(base) {
