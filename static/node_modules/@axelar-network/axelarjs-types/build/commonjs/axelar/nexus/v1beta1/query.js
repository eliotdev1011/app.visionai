  ...
  fromJSON(object) {
    return {
      ...
      state: isSet(object.state)
        ? (0, types_1.transferStateFromJSON)(object.state)
        : 0,
...
exports.TransfersForChainResponse = {
      ...
      switch (tag >>> 3) {
        case 1:
          message.transfers.push(
            types_1.CrossChainTransfer.decode(reader, reader.uint32())
          );
          break;
        case 2:
  ...
  toJSON(message) {
    ...
    if (message.transfers) {
      obj.transfers = message.transfers.map((e) =>
        e ? types_1.CrossChainTransfer.toJSON(e) : undefined
      );
    } else {
      obj.transfers = [];
    }
  ...
  fromPartial(object) {
    const message = createBaseTransfersForChainResponse();
    message.transfers =
      object.transfers?.map((e) => types_1.CrossChainTransfer.fromPartial(e)) ||
      [];
    message.pagination =
      object.pagination !== undefined && object.pagination !== null
  ...
  fromJSON(object) {
    return {
      feeInfo: isSet(object.feeInfo)
        ? types_1.FeeInfo.fromJSON(object.feeInfo)
        : undefined,
    };
  },
  toJSON(message) {
    ...
    message.feeInfo !== undefined &&
      (obj.feeInfo = message.feeInfo
        ? types_1.FeeInfo.toJSON(message.feeInfo)
        : undefined);
    return obj;
  },
  create(base) {
...
exports.ChainStateResponse = {
  ...
  fromJSON(object) {
    return {
      state: isSet(object.state)
        ? types_2.ChainState.fromJSON(object.state)
        : undefined,
    };
  },
  toJSON(message) {
    ...
    message.state !== undefined &&
      (obj.state = message.state
        ? types_2.ChainState.toJSON(message.state)
        : undefined);
    return obj;
  },
  create(base) {
...
exports.TransferRateLimitResponse = {
  encode(message, writer = minimal_1.default.Writer.create()) {
    if (message.transferRateLimit !== undefined) {
      exports.TransferRateLimit.encode(
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.transferRateLimit = exports.TransferRateLimit.decode(
            reader,
            reader.uint32()
          );
          break;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          message.timeLeft = duration_1.Duration.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object) {
    return {
      ...
      timeLeft: isSet(object.timeLeft)
        ? duration_1.Duration.fromJSON(object.timeLeft)
        : undefined,
    };
  },
  toJSON(message) {
    ...
    message.timeLeft !== undefined &&
      (obj.timeLeft = message.timeLeft
        ? duration_1.Duration.toJSON(message.timeLeft)
        : undefined);
    return obj;
  },
  create(base) {
...
exports.MessageResponse = {
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.message = types_1.GeneralMessage.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object) {
    return {
      message: isSet(object.message)
        ? types_1.GeneralMessage.fromJSON(object.message)
        : undefined,
    };
  },
  toJSON(message) {
    ...
    message.message !== undefined &&
      (obj.message = message.message
        ? types_1.GeneralMessage.toJSON(message.message)
        : undefined);
    return obj;
  },
  create(base) {
