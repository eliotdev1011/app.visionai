...
class MsgServiceClientImpl {
  ...
  RegisterChainMaintainer(request) {
    ...
    return promise.then((data) =>
      tx_1.RegisterChainMaintainerResponse.decode(
  ...
  DeregisterChainMaintainer(request) {
    ...
    return promise.then((data) =>
      tx_1.DeregisterChainMaintainerResponse.decode(
        new minimal_1.default.Reader(data)
      )
    );
  }
  ActivateChain(request) {
    ...
    return promise.then((data) =>
      tx_1.ActivateChainResponse.decode(new minimal_1.default.Reader(data))
    );
  }
  DeactivateChain(request) {
    ...
    return promise.then((data) =>
      tx_1.DeactivateChainResponse.decode(new minimal_1.default.Reader(data))
    );
  }
  RegisterAssetFee(request) {
    ...
    return promise.then((data) =>
      tx_1.RegisterAssetFeeResponse.decode(new minimal_1.default.Reader(data))
    );
  }
  SetTransferRateLimit(request) {
    ...
    return promise.then((data) =>
      tx_1.SetTransferRateLimitResponse.decode(
        new minimal_1.default.Reader(data)
      )
    );
  }
...
class QueryServiceClientImpl {
  ...
  LatestDepositAddress(request) {
    ...
    return promise.then((data) =>
      query_1.LatestDepositAddressResponse.decode(
        new minimal_1.default.Reader(data)
      )
    );
  }
  TransfersForChain(request) {
    ...
    return promise.then((data) =>
      query_1.TransfersForChainResponse.decode(
        new minimal_1.default.Reader(data)
      )
    );
  }
  FeeInfo(request) {
    ...
    return promise.then((data) =>
      query_1.FeeInfoResponse.decode(new minimal_1.default.Reader(data))
    );
  }
  TransferFee(request) {
    ...
    return promise.then((data) =>
      query_1.TransferFeeResponse.decode(new minimal_1.default.Reader(data))
    );
  }
  Chains(request) {
  ...
  Assets(request) {
    ...
    return promise.then((data) =>
      query_1.AssetsResponse.decode(new minimal_1.default.Reader(data))
    );
  }
  ChainState(request) {
    ...
    return promise.then((data) =>
      query_1.ChainStateResponse.decode(new minimal_1.default.Reader(data))
    );
  }
  ChainsByAsset(request) {
    ...
    return promise.then((data) =>
      query_1.ChainsByAssetResponse.decode(new minimal_1.default.Reader(data))
    );
  }
  RecipientAddress(request) {
    ...
    return promise.then((data) =>
      query_1.RecipientAddressResponse.decode(
        new minimal_1.default.Reader(data)
      )
    );
  }
  ChainMaintainers(request) {
    ...
    return promise.then((data) =>
      query_1.ChainMaintainersResponse.decode(
        new minimal_1.default.Reader(data)
      )
    );
  }
  TransferRateLimit(request) {
    ...
    return promise.then((data) =>
      query_1.TransferRateLimitResponse.decode(
        new minimal_1.default.Reader(data)
      )
    );
  }
  Message(request) {
    ...
    return promise.then((data) =>
      query_1.MessageResponse.decode(new minimal_1.default.Reader(data))
    );
  }
}
