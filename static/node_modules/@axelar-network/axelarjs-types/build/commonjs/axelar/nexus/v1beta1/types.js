    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.missingVotes = bitmap_1.Bitmap.decode(
            reader,
            reader.uint32()
          );
          break;
        case 3:
          message.incorrectVotes = bitmap_1.Bitmap.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object) {
    return {
      ...
      missingVotes: isSet(object.missingVotes)
        ? bitmap_1.Bitmap.fromJSON(object.missingVotes)
        : undefined,
      incorrectVotes: isSet(object.incorrectVotes)
        ? bitmap_1.Bitmap.fromJSON(object.incorrectVotes)
        : undefined,
  ...
  toJSON(message) {
    ...
    message.missingVotes !== undefined &&
      (obj.missingVotes = message.missingVotes
        ? bitmap_1.Bitmap.toJSON(message.missingVotes)
        : undefined);
    message.incorrectVotes !== undefined &&
      (obj.incorrectVotes = message.incorrectVotes
        ? bitmap_1.Bitmap.toJSON(message.incorrectVotes)
        : undefined);
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          message.maintainerStates.push(
            exports.MaintainerState.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  toJSON(message) {
    ...
    if (message.maintainerStates) {
      obj.maintainerStates = message.maintainerStates.map((e) =>
        e ? exports.MaintainerState.toJSON(e) : undefined
      );
    } else {
  ...
  fromPartial(object) {
    ...
    message.chain =
      object.chain !== undefined && object.chain !== null
        ? types_1.Chain.fromPartial(object.chain)
        : undefined;
    message.activated = object.activated ?? false;
    message.assets =
      object.assets?.map((e) => types_1.Asset.fromPartial(e)) || [];
    message.maintainerStates =
      object.maintainerStates?.map((e) =>
        exports.MaintainerState.fromPartial(e)
      ) || [];
    return message;
  },
};
...
exports.LinkedAddresses = {
  encode(message, writer = minimal_1.default.Writer.create()) {
    if (message.depositAddress !== undefined) {
      types_1.CrossChainAddress.encode(
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.depositAddress = types_1.CrossChainAddress.decode(
            reader,
            reader.uint32()
          );
          break;
        case 2:
          message.recipientAddress = types_1.CrossChainAddress.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object) {
    return {
      ...
      limit: isSet(object.limit)
        ? coin_1.Coin.fromJSON(object.limit)
        : undefined,
      window: isSet(object.window)
        ? duration_1.Duration.fromJSON(object.window)
        : undefined,
    };
  },
  toJSON(message) {
    ...
    message.limit !== undefined &&
      (obj.limit = message.limit
        ? coin_1.Coin.toJSON(message.limit)
        : undefined);
    message.window !== undefined &&
      (obj.window = message.window
        ? duration_1.Duration.toJSON(message.window)
        : undefined);
    return obj;
  },
  create(base) {
  ...
  fromPartial(object) {
    ...
    message.limit =
      object.limit !== undefined && object.limit !== null
        ? coin_1.Coin.fromPartial(object.limit)
        : undefined;
    message.window =
  ...
  fromJSON(object) {
    return {
      ...
      epoch: isSet(object.epoch)
        ? long_1.default.fromValue(object.epoch)
        : long_1.default.UZERO,
      direction: isSet(object.direction)
        ? (0, types_1.transferDirectionFromJSON)(object.direction)
        : 0,
    };
  },
  toJSON(message) {
    ...
    message.amount !== undefined &&
      (obj.amount = message.amount
        ? coin_1.Coin.toJSON(message.amount)
        : undefined);
