    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 8:
          const entry8 = exports.Snapshot_ParticipantsEntry.decode(
            reader,
            reader.uint32()
          );
  ...
  fromJSON(object) {
    return {
      ...
      value: isSet(object.value)
        ? exports.Participant.fromJSON(object.value)
        : undefined,
    };
  },
  toJSON(message) {
    ...
    message.value !== undefined &&
      (obj.value = message.value
        ? exports.Participant.toJSON(message.value)
        : undefined);
    return obj;
  },
  create(base) {
