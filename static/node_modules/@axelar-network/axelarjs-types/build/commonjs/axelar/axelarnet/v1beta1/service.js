...
class MsgServiceClientImpl {
  ...
  ExecutePendingTransfers(request) {
    ...
    return promise.then((data) =>
      tx_1.ExecutePendingTransfersResponse.decode(
  ...
  AddCosmosBasedChain(request) {
    ...
    return promise.then((data) =>
      tx_1.AddCosmosBasedChainResponse.decode(
        new minimal_1.default.Reader(data)
      )
    );
  }
  RegisterAsset(request) {
    ...
    return promise.then((data) =>
      tx_1.RegisterAssetResponse.decode(new minimal_1.default.Reader(data))
    );
  }
  RouteIBCTransfers(request) {
    ...
    return promise.then((data) =>
      tx_1.RouteIBCTransfersResponse.decode(new minimal_1.default.Reader(data))
    );
  }
  RegisterFeeCollector(request) {
    ...
    return promise.then((data) =>
      tx_1.RegisterFeeCollectorResponse.decode(
        new minimal_1.default.Reader(data)
      )
    );
  }
  RetryIBCTransfer(request) {
    ...
    return promise.then((data) =>
      tx_1.RetryIBCTransferResponse.decode(new minimal_1.default.Reader(data))
    );
  }
  RouteMessage(request) {
    ...
    return promise.then((data) =>
      tx_1.RouteMessageResponse.decode(new minimal_1.default.Reader(data))
    );
  }
  CallContract(request) {
    ...
    return promise.then((data) =>
      tx_1.CallContractResponse.decode(new minimal_1.default.Reader(data))
    );
  }
}
...
class QueryServiceClientImpl {
  ...
  PendingIBCTransferCount(request) {
    const data =
      query_1.PendingIBCTransferCountRequest.encode(request).finish();
    const promise = this.rpc.request(
      this.service,
    ...
    return promise.then((data) =>
      query_1.PendingIBCTransferCountResponse.decode(
        new minimal_1.default.Reader(data)
      )
    );
  }
