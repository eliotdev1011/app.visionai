...
exports.AddCosmosBasedChainRequest = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 5:
          message.nativeAssets.push(
            types_1.Asset.decode(reader, reader.uint32())
          );
          break;
        case 6:
  ...
  fromPartial(object) {
    ...
    message.nativeAssets =
      object.nativeAssets?.map((e) => types_1.Asset.fromPartial(e)) || [];
  ...
  fromJSON(object) {
    return {
      ...
      asset: isSet(object.asset)
        ? types_1.Asset.fromJSON(object.asset)
        : undefined,
  ...
  toJSON(message) {
    ...
    message.asset !== undefined &&
      (obj.asset = message.asset
        ? types_1.Asset.toJSON(message.asset)
        : undefined);
  ...
  fromPartial(object) {
    ...
    message.asset =
      object.asset !== undefined && object.asset !== null
        ? types_1.Asset.fromPartial(object.asset)
        : undefined;
...
exports.CallContractRequest = {
  ...
  toJSON(message) {
    ...
    message.fee !== undefined &&
      (obj.fee = message.fee ? types_2.Fee.toJSON(message.fee) : undefined);
    return obj;
  },
  create(base) {
  ...
  fromPartial(object) {
    ...
    message.fee =
      object.fee !== undefined && object.fee !== null
        ? types_2.Fee.fromPartial(object.fee)
        : undefined;
    return message;
  },
};
