...
exports.Fee =
  ...
  exports.CosmosChain =
  exports.IBCTransfer =
  exports.iBCTransfer_StatusToJSON =
  exports.iBCTransfer_StatusFromJSON =
  exports.IBCTransfer_Status =
...
(function (IBCTransfer_Status) {
  IBCTransfer_Status[(IBCTransfer_Status["STATUS_UNSPECIFIED"] = 0)] =
    "STATUS_UNSPECIFIED";
  IBCTransfer_Status[(IBCTransfer_Status["STATUS_PENDING"] = 1)] =
    "STATUS_PENDING";
  IBCTransfer_Status[(IBCTransfer_Status["STATUS_COMPLETED"] = 2)] =
    "STATUS_COMPLETED";
  IBCTransfer_Status[(IBCTransfer_Status["STATUS_FAILED"] = 3)] =
    "STATUS_FAILED";
  IBCTransfer_Status[(IBCTransfer_Status["UNRECOGNIZED"] = -1)] =
    "UNRECOGNIZED";
})(
  (IBCTransfer_Status =
    exports.IBCTransfer_Status || (exports.IBCTransfer_Status = {}))
);
  ...
  toJSON(message) {
    ...
    message.token !== undefined &&
      (obj.token = message.token
        ? coin_1.Coin.toJSON(message.token)
        : undefined);
...
exports.CosmosChain = {
  ...
  toJSON(message) {
    ...
    if (message.assets) {
      obj.assets = message.assets.map((e) =>
        e ? exports.Asset.toJSON(e) : undefined
      );
    } else {
      obj.assets = [];
    }
  ...
  fromPartial(object) {
    ...
    message.assets =
      object.assets?.map((e) => exports.Asset.fromPartial(e)) || [];
