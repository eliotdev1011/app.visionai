...
exports.PollParticipants =
  ...
  exports.pollStateToJSON =
  exports.pollStateFromJSON =
  exports.PollState =
...
var PollState;
(function (PollState) {
  PollState[(PollState["POLL_STATE_UNSPECIFIED"] = 0)] =
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          message.votingThreshold = threshold_1.Threshold.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object) {
    return {
      ...
      result: isSet(object.result)
        ? any_1.Any.fromJSON(object.result)
        : undefined,
      votingThreshold: isSet(object.votingThreshold)
        ? threshold_1.Threshold.fromJSON(object.votingThreshold)
        : undefined,
      ...
      snapshot: isSet(object.snapshot)
        ? types_1.Snapshot.fromJSON(object.snapshot)
        : undefined,
      module: isSet(object.module) ? String(object.module) : "",
      moduleMetadata: isSet(object.moduleMetadata)
        ? any_1.Any.fromJSON(object.moduleMetadata)
        : undefined,
    };
  },
  toJSON(message) {
