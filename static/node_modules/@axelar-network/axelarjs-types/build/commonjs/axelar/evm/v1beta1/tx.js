  ...
  fromJSON(object) {
    return {
      ...
      asset: isSet(object.asset)
        ? types_2.Asset.fromJSON(object.asset)
        : undefined,
    };
  },
  toJSON(message) {
    ...
    message.asset !== undefined &&
      (obj.asset = message.asset
        ? types_2.Asset.toJSON(message.asset)
        : undefined);
    return obj;
  },
  create(base) {
  ...
  fromPartial(object) {
    ...
    message.asset =
      object.asset !== undefined && object.asset !== null
        ? types_2.Asset.fromPartial(object.asset)
        : undefined;
    return message;
  },
};
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.tokenDetails = types_2.TokenDetails.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object) {
    return {
      ...
      tokenDetails: isSet(object.tokenDetails)
        ? types_2.TokenDetails.fromJSON(object.tokenDetails)
        : undefined,
      address: isSet(object.address)
        ? bytesFromBase64(object.address)
        : new Uint8Array(),
  ...
  toJSON(message) {
    ...
    message.tokenDetails !== undefined &&
      (obj.tokenDetails = message.tokenDetails
        ? types_2.TokenDetails.toJSON(message.tokenDetails)
        : undefined);
    message.address !== undefined &&
      (obj.address = base64FromBytes(
        message.address !== undefined ? message.address : new Uint8Array()
