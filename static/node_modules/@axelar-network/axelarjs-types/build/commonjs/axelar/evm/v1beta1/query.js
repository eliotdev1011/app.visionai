...
exports.Proof =
  ...
  exports.tokenTypeToJSON =
  exports.tokenTypeFromJSON =
  exports.TokenType =
  exports.chainStatusToJSON =
  exports.chainStatusFromJSON =
  exports.ChainStatus =
...
(function (ChainStatus) {
  ChainStatus[(ChainStatus["CHAIN_STATUS_UNSPECIFIED"] = 0)] =
    "CHAIN_STATUS_UNSPECIFIED";
  ChainStatus[(ChainStatus["CHAIN_STATUS_ACTIVATED"] = 1)] =
    "CHAIN_STATUS_ACTIVATED";
  ChainStatus[(ChainStatus["CHAIN_STATUS_DEACTIVATED"] = 2)] =
...
var TokenType;
(function (TokenType) {
  TokenType[(TokenType["TOKEN_TYPE_UNSPECIFIED"] = 0)] =
  ...
  fromJSON(object) {
    return {
      ...
      status: isSet(object.status)
        ? (0, types_1.batchedCommandsStatusFromJSON)(object.status)
        : 0,
      ...
      commandIds: Array.isArray(object?.commandIds)
        ? object.commandIds.map((e) => String(e))
        : [],
  ...
  toJSON(message) {
    ...
    message.proof !== undefined &&
      (obj.proof = message.proof
        ? exports.Proof.toJSON(message.proof)
        : undefined);
    return obj;
  },
  create(base) {
...
exports.KeyAddressResponse = {
  encode(message, writer = minimal_1.default.Writer.create()) {
    ...
    for (const v of message.addresses) {
      exports.KeyAddressResponse_WeightedAddress.encode(
        v,
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.addresses.push(
            exports.KeyAddressResponse_WeightedAddress.decode(
              reader,
              reader.uint32()
            )
          );
    ...
    return {
      ...
      addresses: Array.isArray(object?.addresses)
        ? object.addresses.map((e) =>
            exports.KeyAddressResponse_WeightedAddress.fromJSON(e)
          )
        : [],
  ...
  toJSON(message) {
    ...
    if (message.addresses) {
      obj.addresses = message.addresses.map((e) =>
        e ? exports.KeyAddressResponse_WeightedAddress.toJSON(e) : undefined
      );
    } else {
      obj.addresses = [];
    }
  ...
  fromPartial(object) {
    ...
    message.addresses =
      object.addresses?.map((e) =>
        exports.KeyAddressResponse_WeightedAddress.fromPartial(e)
      ) || [];
...
exports.DepositStateRequest = {
  encode(message, writer = minimal_1.default.Writer.create()) {
    ...
    if (message.params !== undefined) {
      exports.QueryDepositStateParams.encode(
        message.params,
        writer.uint32(18).fork()
      ).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.params = exports.QueryDepositStateParams.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object) {
    return {
      ...
      params: isSet(object.params)
        ? exports.QueryDepositStateParams.fromJSON(object.params)
        : undefined,
    };
  },
  toJSON(message) {
    ...
    message.params !== undefined &&
      (obj.params = message.params
        ? exports.QueryDepositStateParams.toJSON(message.params)
        : undefined);
    return obj;
  },
  create(base) {
...
exports.DepositStateResponse = {
  ...
  fromJSON(object) {
    return {
      status: isSet(object.status)
        ? (0, types_1.depositStatusFromJSON)(object.status)
        : 0,
    };
  },
  toJSON(message) {
  ...
  fromJSON(object) {
    return {
      event: isSet(object.event)
        ? types_1.Event.fromJSON(object.event)
        : undefined,
    };
  },
  toJSON(message) {
    ...
    message.event !== undefined &&
      (obj.event = message.event
        ? types_1.Event.toJSON(message.event)
        : undefined);
    return obj;
  },
  create(base) {
  ...
  fromPartial(object) {
    ...
    message.event =
      object.event !== undefined && object.event !== null
        ? types_1.Event.fromPartial(object.event)
        : undefined;
    return message;
  },
};
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          const entry3 = exports.CommandResponse_ParamsEntry.decode(
            reader,
            reader.uint32()
          );
      ...
      switch (tag >>> 3) {
        case 1:
          message.commands.push(
            exports.QueryCommandResponse.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  toJSON(message) {
    ...
    if (message.commands) {
      obj.commands = message.commands.map((e) =>
        e ? exports.QueryCommandResponse.toJSON(e) : undefined
      );
    } else {
      obj.commands = [];
    }
  ...
  fromPartial(object) {
    ...
    message.commands =
      object.commands?.map((e) =>
        exports.QueryCommandResponse.fromPartial(e)
      ) || [];
    return message;
  },
};
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          const entry3 = exports.QueryCommandResponse_ParamsEntry.decode(
            reader,
            reader.uint32()
          );
          if (entry3.value !== undefined) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.burnerInfo = types_1.BurnerInfo.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object) {
    return {
      ...
      burnerInfo: isSet(object.burnerInfo)
        ? types_1.BurnerInfo.fromJSON(object.burnerInfo)
        : undefined,
    };
  },
  toJSON(message) {
    ...
    message.burnerInfo !== undefined &&
      (obj.burnerInfo = message.burnerInfo
        ? types_1.BurnerInfo.toJSON(message.burnerInfo)
        : undefined);
    return obj;
  },
  create(base) {
...
exports.ERC20TokensResponse = {
  encode(message, writer = minimal_1.default.Writer.create()) {
    for (const v of message.tokens) {
      exports.ERC20TokensResponse_Token.encode(
        v,
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.tokens.push(
            exports.ERC20TokensResponse_Token.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  fromJSON(object) {
    return {
      tokens: Array.isArray(object?.tokens)
        ? object.tokens.map((e) =>
            exports.ERC20TokensResponse_Token.fromJSON(e)
          )
        : [],
    };
  },
  toJSON(message) {
    ...
    if (message.tokens) {
      obj.tokens = message.tokens.map((e) =>
        e ? exports.ERC20TokensResponse_Token.toJSON(e) : undefined
      );
    } else {
      obj.tokens = [];
    }
  ...
  fromPartial(object) {
    ...
    message.tokens =
      object.tokens?.map((e) =>
        exports.ERC20TokensResponse_Token.fromPartial(e)
      ) || [];
    return message;
  },
};
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.details = types_1.TokenDetails.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object) {
    return {
      ...
      details: isSet(object.details)
        ? types_1.TokenDetails.fromJSON(object.details)
        : undefined,
      address: isSet(object.address) ? String(object.address) : "",
      confirmed: isSet(object.confirmed) ? Boolean(object.confirmed) : false,
  ...
  toJSON(message) {
    ...
    message.details !== undefined &&
      (obj.details = message.details
        ? types_1.TokenDetails.toJSON(message.details)
        : undefined);
    message.address !== undefined && (obj.address = message.address);
    message.confirmed !== undefined && (obj.confirmed = message.confirmed);
  ...
  fromJSON(object) {
    return {
      ...
      signatures: Array.isArray(object?.signatures)
        ? object.signatures.map((e) => String(e))
        : [],
    };
  },
  toJSON(message) {
