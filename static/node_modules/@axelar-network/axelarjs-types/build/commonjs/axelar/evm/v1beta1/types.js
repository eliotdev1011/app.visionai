...
exports.PollMetadata =
  ...
  exports.Event =
  exports.VoteEvents =
  exports.event_StatusToJSON =
  exports.event_StatusFromJSON =
  exports.Event_Status =
  exports.depositStatusToJSON =
  exports.depositStatusFromJSON =
  exports.DepositStatus =
  exports.sigTypeToJSON =
  exports.sigTypeFromJSON =
  exports.SigType =
  exports.batchedCommandsStatusToJSON =
  exports.batchedCommandsStatusFromJSON =
  exports.BatchedCommandsStatus =
  exports.commandTypeToJSON =
  exports.commandTypeFromJSON =
  exports.CommandType =
  exports.statusToJSON =
  exports.statusFromJSON =
  exports.Status =
...
(function (CommandType) {
  CommandType[(CommandType["COMMAND_TYPE_UNSPECIFIED"] = 0)] =
    "COMMAND_TYPE_UNSPECIFIED";
  CommandType[(CommandType["COMMAND_TYPE_MINT_TOKEN"] = 1)] =
    "COMMAND_TYPE_MINT_TOKEN";
  CommandType[(CommandType["COMMAND_TYPE_DEPLOY_TOKEN"] = 2)] =
    "COMMAND_TYPE_DEPLOY_TOKEN";
  CommandType[(CommandType["COMMAND_TYPE_BURN_TOKEN"] = 3)] =
    "COMMAND_TYPE_BURN_TOKEN";
  CommandType[(CommandType["COMMAND_TYPE_TRANSFER_OPERATORSHIP"] = 4)] =
    "COMMAND_TYPE_TRANSFER_OPERATORSHIP";
  CommandType[
    (CommandType["COMMAND_TYPE_APPROVE_CONTRACT_CALL_WITH_MINT"] = 5)
  ] = "COMMAND_TYPE_APPROVE_CONTRACT_CALL_WITH_MINT";
  CommandType[(CommandType["COMMAND_TYPE_APPROVE_CONTRACT_CALL"] = 6)] =
...
(function (BatchedCommandsStatus) {
  BatchedCommandsStatus[
    (BatchedCommandsStatus["BATCHED_COMMANDS_STATUS_UNSPECIFIED"] = 0)
  ] = "BATCHED_COMMANDS_STATUS_UNSPECIFIED";
  BatchedCommandsStatus[
    (BatchedCommandsStatus["BATCHED_COMMANDS_STATUS_SIGNING"] = 1)
  ] = "BATCHED_COMMANDS_STATUS_SIGNING";
  BatchedCommandsStatus[
    (BatchedCommandsStatus["BATCHED_COMMANDS_STATUS_ABORTED"] = 2)
  ] = "BATCHED_COMMANDS_STATUS_ABORTED";
  BatchedCommandsStatus[
    (BatchedCommandsStatus["BATCHED_COMMANDS_STATUS_SIGNED"] = 3)
  ] = "BATCHED_COMMANDS_STATUS_SIGNED";
  BatchedCommandsStatus[(BatchedCommandsStatus["UNRECOGNIZED"] = -1)] =
    "UNRECOGNIZED";
})(
  (BatchedCommandsStatus =
    exports.BatchedCommandsStatus || (exports.BatchedCommandsStatus = {}))
);
...
(function (DepositStatus) {
  DepositStatus[(DepositStatus["DEPOSIT_STATUS_UNSPECIFIED"] = 0)] =
    "DEPOSIT_STATUS_UNSPECIFIED";
  DepositStatus[(DepositStatus["DEPOSIT_STATUS_PENDING"] = 1)] =
    "DEPOSIT_STATUS_PENDING";
  DepositStatus[(DepositStatus["DEPOSIT_STATUS_CONFIRMED"] = 2)] =
    "DEPOSIT_STATUS_CONFIRMED";
  DepositStatus[(DepositStatus["DEPOSIT_STATUS_BURNED"] = 3)] =
...
exports.VoteEvents = {
  ...
  toJSON(message) {
    ...
    if (message.events) {
      obj.events = message.events.map((e) =>
        e ? exports.Event.toJSON(e) : undefined
      );
    } else {
      obj.events = [];
    }
  ...
  fromPartial(object) {
    ...
    message.events =
      object.events?.map((e) => exports.Event.fromPartial(e)) || [];
    return message;
  },
};
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          message.tokenSent = exports.EventTokenSent.decode(
            reader,
            reader.uint32()
          );
          break;
        case 6:
          message.contractCall = exports.EventContractCall.decode(
            reader,
            reader.uint32()
          );
          break;
        case 7:
          message.contractCallWithToken =
            exports.EventContractCallWithToken.decode(reader, reader.uint32());
          break;
        case 8:
          message.transfer = exports.EventTransfer.decode(
            reader,
            reader.uint32()
          );
          break;
        case 9:
          message.tokenDeployed = exports.EventTokenDeployed.decode(
            reader,
            reader.uint32()
          );
          break;
        case 10:
          message.multisigOwnershipTransferred =
            exports.EventMultisigOwnershipTransferred.decode(
              reader,
              reader.uint32()
            );
          break;
        case 11:
          message.multisigOperatorshipTransferred =
            exports.EventMultisigOperatorshipTransferred.decode(
              reader,
              reader.uint32()
            );
          break;
  ...
  fromJSON(object) {
    return {
      ...
      tokenSent: isSet(object.tokenSent)
        ? exports.EventTokenSent.fromJSON(object.tokenSent)
        : undefined,
      contractCall: isSet(object.contractCall)
        ? exports.EventContractCall.fromJSON(object.contractCall)
        : undefined,
      contractCallWithToken: isSet(object.contractCallWithToken)
        ? exports.EventContractCallWithToken.fromJSON(
            object.contractCallWithToken
          )
        : undefined,
      transfer: isSet(object.transfer)
        ? exports.EventTransfer.fromJSON(object.transfer)
        : undefined,
      ...
      multisigOwnershipTransferred: isSet(object.multisigOwnershipTransferred)
        ? exports.EventMultisigOwnershipTransferred.fromJSON(
      ...
      multisigOperatorshipTransferred: isSet(
        ...
        ? exports.EventMultisigOperatorshipTransferred.fromJSON(
            object.multisigOperatorshipTransferred
          )
        : undefined,
    };
  ...
  toJSON(message) {
    ...
    message.multisigOwnershipTransferred !== undefined &&
      (obj.multisigOwnershipTransferred = message.multisigOwnershipTransferred
        ? exports.EventMultisigOwnershipTransferred.toJSON(
            message.multisigOwnershipTransferred
          )
        : undefined);
    message.multisigOperatorshipTransferred !== undefined &&
      (obj.multisigOperatorshipTransferred =
        message.multisigOperatorshipTransferred
          ? exports.EventMultisigOperatorshipTransferred.toJSON(
              message.multisigOperatorshipTransferred
            )
          : undefined);
    return obj;
  ...
  fromPartial(object) {
    ...
    message.contractCallWithToken =
      ...
      object.contractCallWithToken !== null
        ? exports.EventContractCallWithToken.fromPartial(
            object.contractCallWithToken
          )
        : undefined;
    message.transfer =
    ...
    message.multisigOwnershipTransferred =
      ...
      object.multisigOwnershipTransferred !== null
        ? exports.EventMultisigOwnershipTransferred.fromPartial(
            object.multisigOwnershipTransferred
          )
        : undefined;
    message.multisigOperatorshipTransferred =
      ...
      object.multisigOperatorshipTransferred !== null
        ? exports.EventMultisigOperatorshipTransferred.fromPartial(
            object.multisigOperatorshipTransferred
          )
        : undefined;
    return message;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.details = exports.TokenDetails.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object) {
    return {
      ...
      details: isSet(object.details)
        ? exports.TokenDetails.fromJSON(object.details)
        : undefined,
      tokenAddress: isSet(object.tokenAddress)
  ...
  toJSON(message) {
    ...
    message.details !== undefined &&
      (obj.details = message.details
        ? exports.TokenDetails.toJSON(message.details)
        : undefined);
    message.tokenAddress !== undefined &&
  ...
  fromJSON(object) {
    return {
      ...
      signature: isSet(object.signature)
        ? any_1.Any.fromJSON(object.signature)
        : undefined,
    };
  },
  toJSON(message) {
    ...
    message.signature !== undefined &&
      (obj.signature = message.signature
        ? any_1.Any.toJSON(message.signature)
        : undefined);
    return obj;
  },
  create(base) {
